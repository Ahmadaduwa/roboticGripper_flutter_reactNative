...
import '../providers/localization_provider.dart'; // Added
          ...
          children: [
            ...
            Expanded(
              child: Consumer<RobotProvider>(
                builder: (context, provider, robotChild) {
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                "${localization.t('confidence')}: ${provider.confidence.toStringAsFixed(2)} %",
                                style: GoogleFonts.outfit(
                                  fontSize: 18,
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "Time", // Skipping translation for 'Time' as it's not in dict, leaving as English for now
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                      ),
